...
class SerialHelper(object):
    ...
    def update(self):
        '''串口查询，按照正则表达式查找USB Serial Port'''
        self.port_list = list(serial.tools.list_ports.grep('USB Serial Port'))
...
A = SerialHelper(Port = 'com1',BaudRate='9600',ByteSize='8',Parity='n',Stopbits='1',Dtr=True,Rts=True)
A.update()